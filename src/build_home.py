...
.beat .lede{margin:22px auto 0;font-size:17px;line-height:1.7;color:var(--ink2);max-width:56ch}
.beat .big{font:600 clamp(50px,10vw,116px)/1 var(--mono);letter-spacing:-.045em;
  text-shadow:0 2px 40px rgba(0,0,0,.6)}
.beat .sm{margin-top:16px;font-size:16px;color:var(--ink2);max-width:52ch;
