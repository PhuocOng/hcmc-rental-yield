...
.nav.on{background:rgba(14,13,12,.78);backdrop-filter:saturate(160%) blur(12px);
...
.beat>div{max-width:840px;width:100%;
...
/* Chu nam tren footage nen mau phu cua giao dien (--ink2/--ink3, von danh cho
   nen panel toi dac) bi chim. Dung trang theo do mo rieng cho phan nay. */
/* Vien chu: paint-order dat NET VIEN xuong duoi phan to mau, nen viet chu giu
   nguyen do day. Neu khong co dong nay thi -webkit-text-stroke an vao trong
   long chu va lam net chu gay di. */
.beat .kick,.beat h1,.beat .lede,.beat .big,.beat .sm{
  paint-order:stroke fill;
  -webkit-text-stroke:.6px rgba(0,0,0,.55)}
.beat h1,.beat .big{-webkit-text-stroke-width:1.1px}
.beat .kick{font:600 11px/1 var(--mono);letter-spacing:.16em;text-transform:uppercase;
  color:rgba(255,255,255,.80);margin-bottom:22px;
  text-shadow:0 1px 3px rgba(0,0,0,.9)}
.beat h1{font-size:clamp(32px,6.2vw,64px);line-height:1.06;
  text-shadow:0 1px 3px rgba(0,0,0,.7),0 2px 40px rgba(0,0,0,.6)}
.beat h1 em{font-style:normal;color:#F49A72;
  -webkit-text-stroke-width:1.4px}   /* mau am, lan vao may nen can vien day hon */
.beat .lede{margin:22px auto 0;font-size:17px;line-height:1.7;max-width:56ch;
  color:rgba(255,255,255,.90);text-shadow:0 1px 3px rgba(0,0,0,.85)}
.beat .big{font:600 clamp(50px,10vw,116px)/1 var(--mono);letter-spacing:-.045em;
  text-shadow:0 1px 3px rgba(0,0,0,.7),0 2px 40px rgba(0,0,0,.6)}
.beat .sm{margin-top:16px;font-size:16px;max-width:52ch;
  margin-left:auto;margin-right:auto;
  color:rgba(255,255,255,.88);text-shadow:0 1px 3px rgba(0,0,0,.85)}
...
.ctasub{margin:16px 0 0;font:400 12.5px/1.5 var(--sans);color:var(--ink3)}
...
(function(){
  ...
  function seek(){ if(seeking) return; seeking=true; seekAt=performance.now();
  ...
  function tick(){
    ...
    if(Math.abs(d)<0.004){ shown=target; running=false; seek(); return; }
